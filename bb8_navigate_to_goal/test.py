...
class BehaviorControl(Node):
    ...
    def update_Odometry(self,Odom):
        ...
        # robot_pos = Twist()
        # robot_pos.linear.x = float(self.globalPos.x)
        # robot_pos.linear.y = float(self.globalPos.y)
        # robot_pos.linear.z = 
        # robot_pos.angular.x = float(self.Init_pos.x)
        # robot_pos.angular.y = float(self.Init_pos.y)
        # robot_pos.angular.z = float(self.Init_ang)
